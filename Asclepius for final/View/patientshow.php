<html>
    <head>
        ...
        <style>
            body{
                margin: 0px;
                background: url(../Resources/doctor.jpg);
                background-size:100%;
                text-align: center;
...
<link rel="stylesheet" href="everything.css">
    ...
    <body>
      ...
      <!-- Welcome to Homepage  -->
      <div>
            <h1 id="admininfo">Patient Information</h1>
        </div>  

        <?php include '../Controller/patientdataload.php'; ?>
        ...
        <div>
            <div id="crudoperation">
                ...
                <form action="../Controller/patientcrud.php" method="post">
